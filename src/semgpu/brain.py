...
# Architecture constants - must match Rust exactly
INPUTS = 36
...
SEG_INPUT_BASE = 0
SEG_BASE_BIAS = SEG_INPUT_BASE + INPUTS * MAX_BASE_HIDDEN  # 2304
SEG_BASE_MOVE = SEG_BASE_BIAS + MAX_BASE_HIDDEN  # 2368
SEG_MOVE_BIAS = SEG_BASE_MOVE + MAX_BASE_HIDDEN * MOVEMENT_OUTPUTS  # 2688
SEG_BASE_SIGHID = SEG_MOVE_BIAS + MOVEMENT_OUTPUTS  # 2693
SEG_SIGHID_BIAS = SEG_BASE_SIGHID + MAX_BASE_HIDDEN * MAX_SIGNAL_HIDDEN  # 4741
SEG_SIGHID_SIGOUT = SEG_SIGHID_BIAS + MAX_SIGNAL_HIDDEN  # 4773
SEG_SIGOUT_BIAS = SEG_SIGHID_SIGOUT + MAX_SIGNAL_HIDDEN * SIGNAL_OUTPUTS  # 4965
SEG_BASE_MEM = SEG_SIGOUT_BIAS + SIGNAL_OUTPUTS  # 4971
SEG_MEM_BIAS = SEG_BASE_MEM + MAX_BASE_HIDDEN * MEMORY_OUTPUTS  # 5483

MAX_GENOME_LEN = SEG_MEM_BIAS + MEMORY_OUTPUTS  # 5491
